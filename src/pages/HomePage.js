...
// import BuildingLocality from "./BuildingLocality";
// import VendorDeliveryBoy from "./VendorDeliveryBoy";

import BootstrapTables from "./tables/BootstrapTables";
// import AdminDashboard from "./dash/AdminDashboard";
// import SummaryDashboard from "./dash/SummaryDashboard";
// import UserDashboard from "./dash/UserDashboard";
// import AddProduct from "./inventory/AddProduct";
// import Category from "./inventory/Category";
// import LocalityProducts from "./inventory/LocalityProducts";
// import ProductBrand from "./inventory/ProductBrand";
// import StockUpdate from "./inventory/StockUpdate";
// import Subcategory from "./inventory/Subcategory";
...
export default () => (
  <Switch>
    ...
    {/* <RouteWithSidebar
      exact
      path={Routes.OrderSheet.path}
      component={OrderSheet}
    /> */}
    {/* <RouteWithSidebar exact path={Routes.Offers.path} component={Offers} /> */}
    {/* <RouteWithSidebar
      exact
      path={Routes.DeliveryStatus.path}
      component={DeliveryStatus}
    /> */}
    {/* <RouteWithSidebar exact path={Routes.Payments.path} component={Payments} /> */}
    {/* <RouteWithSidebar
      exact
      path={Routes.BuildingLocality.path}
      component={BuildingLocality}
    /> */}
    {/* <RouteWithSidebar
      exact
      path={Routes.VendorDeliveryBoy.path}
      component={VendorDeliveryBoy}
    /> */}
    ...
    <RouteWithSidebar
      exact
      path={Routes.SummaryDashboard.path}
    ...
    <RouteWithSidebar
      exact
      path={Routes.LocalityProducts.path}
      component={LocalityProducts}
    />

    <RouteWithSidebar
      exact
      path={Routes.ProductBrand.path}
      component={ProductBrand}
    />

    <RouteWithSidebar
      exact
      path={Routes.StockUpdate.path}
